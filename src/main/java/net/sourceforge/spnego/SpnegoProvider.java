 ...
 * 
 * <p>
 * Take a look at the {@link net.sourceforge.spnego.SpnegoHttpURLConnection} class and the
 * {@link net.sourceforge.spnego.SpnegoHttpFilter} class before attempting to implement your
 * own HTTP client.
 * </p>
 * 
...
public final class SpnegoProvider {
    ...
    /**
     * Returns the {@link net.sourceforge.spnego.SpnegoAuthScheme} mechanism used to authenticate
     * the request. 
     * 
     * <p>
...
//            }
    ...
    /**
     * Returns the {@link net.sourceforge.spnego.SpnegoAuthScheme} or null if header is missing.
     * 
     * <p>
